...
seven	DEFB "Please enter how many verses you'd like to print: ",0
eight	DEFB "Please enter how many verses you'd like to print in binary:",0
elev	DEFB "\n",0
error	DEFB "INVALID INPUT",0
start	DEFB "Enter 'b' for Binary or 'd' for decimal:",0
Blabel	DEFB "You entered a 'B'",0
blabel	DEFB "b",0
Dlabel	DEFB "You entered a 'D'",0
dlabel	DEFB "d",0
...
binary	ADRL R0, Blabel
	SWI 3
	ADRL R0, elev
	SWI 3
	ADRL R0, eight
	SWI 3
	BL loopbi ; returns r1
	B then

decimal	ADRL R0, Dlabel
	SWI 3
	ADRL R0, elev
	SWI 3
	ADRL R0, seven
	SWI 3
	BL loopdec ; returns r1
	B then
